...
const ServiceDetail = () => {
  ...
  if (!service) {
    return (
      <div className="py-32 text-center">
        <h1 className="text-2xl font-bold text-foreground mb-4">Service not found</h1>
        <Link to="/services" className="text-[hsl(var(--primary))] hover:underline">
          ← Back to Services
        </Link>
      </div>
    );
  ...
  return (
    <div>
      ...
      <section className="relative h-[50vh] min-h-[350px] overflow-hidden">
       <ImageSlider
    images={[service.image, hero1, hero2]}
  ...
  {/* 🔥 BACK BUTTON (TOP LEFT FIXED & VISIBLE) */}
  <div className="absolute top-6 left-6 z-50">
    <Link
      ...
      shadow-lg
      hover:bg-[hsl(var(--glow))] hover:text-white 
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <ScrollReveal direction="left">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-4 mt-8">
                What we offer:
              </h3>
              ...
              <ul className="space-y-3">
                {service.subServices.map((sub) => {
                  ...
                  return (
                    <li key={sub.name} className="flex items-center gap-3 text-muted-foreground">
                      <div className="p-1.5 rounded-lg bg-[hsl(var(--primary)/0.1)]">
                        <SubIcon className="w-4 h-4 text-[hsl(var(--primary))]" />
                      </div>
                      {sub.name}
                    </li>
                  );
        ...
        <div className="container mx-auto px-4 lg:px-8 text-center">
          <ScrollReveal>
            ...
            <Link
              ...
              font-semibold hover:brightness-110 active:scale-[0.97] transition-all"
            >
              Get in Touch
            </Link>
          </ScrollReveal>
