...
const Index = () => {
        ...
        <div className="relative container mx-auto px-4 lg:px-8 h-full flex items-center">
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-[hsl(var(--section-dark-foreground)/0.75)] mb-8 max-w-xl animate-hero-fade" style={{ animationDelay: "400ms" }}>
              BPR Solutions is a global engineering and technology solutions provider specializing in Telecom, GIS, LiDAR, BIM, CYCLONE Modeling, Survey,Data Annotation, and innovative digital solutions.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <ScrollReveal direction="left">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                BPR Solutions is a global engineering and technology solutions provider specializing in Telecom Engineering | GIS Drafting & Mapping | LIDAR | BIM, CYCLONE Modeling | Survey |Data Annotation, and innovative digital solutions. Headquartered in Visakhapatnam, India, we support clients worldwide by delivering high-precision, cost-effective, and innovative digital engineering solutions.
              </p>
  ...
  <div className="w-full h-[320px] md:h-[420px] lg:h-[450px] rounded-2xl overflow-hidden shadow-xl">
